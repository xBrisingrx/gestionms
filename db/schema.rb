...
ActiveRecord::Schema.define(version: 2019_07_02_215231) do
  ...
  create_table "client_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "fleet_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "name", limit: 50
    t.string "comment"
    t.boolean "active", default: true
    t.datetime "created_at", null: false
  ...
  create_table "fleets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "code"
  ...
  create_table "iva_conditions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", comment: "Porcentaje en la facturacion, responsables inscriptos se discrimina el 21% ", force: :cascade do |t|
  ...
  create_table "people", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "name", limit: 50
  ...
  create_table "person_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", comment: "Discriminador de jerarquia en la empresa.", force: :cascade do |t|
    t.string "name", limit: 50
    t.string "comment"
    t.boolean "active", default: true
    t.datetime "created_at", null: false
  ...
  create_table "rols", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "name", limit: 20
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "sale_conditions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", comment: "Descuentos que se le puede llegar a hacer a un cliente.", force: :cascade do |t|
    t.string "condition", limit: 50
    t.float "porcent"
    t.string "comment"
    t.boolean "active", default: true
  ...
  create_table "ticket_answers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.bigint "ticket_id"
    t.bigint "user_id"
    t.string "detail"
    t.boolean "active", default: true
  ...
  create_table "ticket_priorities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "ticket_statuses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "ticket_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
    t.string "name", limit: 50
    t.string "comment"
    t.boolean "active", default: true
    t.datetime "created_at", null: false
